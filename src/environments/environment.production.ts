export const environment = {
  ...
  createPaymentIntentUrl: 'https://us-central1-coach-othmeni.cloudfunctions.net/createPaymentIntent',
  verifyPaymentUrl: 'https://us-central1-coach-othmeni.cloudfunctions.net/verifyPaymentAndSave'
};
